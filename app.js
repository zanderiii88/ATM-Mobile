...
function homeIcon(kind) {
  ...
  if (kind === 'musicfor') return `<svg class="home-svg musicfor-svg" viewBox="0 0 84 28" aria-hidden="true"><g transform="translate(0 1)"><circle cx="10" cy="17" r="7"></circle><path d="M15 12 24 3"></path><path d="M21 3h6"></path></g><g transform="translate(31 2)"><path d="M2 16h21l-2-8H6z"></path><path d="M4 16v5m17-5v5"></path><circle cx="7" cy="20" r="2"></circle><circle cx="18" cy="20" r="2"></circle></g><g transform="translate(61 4)"><path d="M2 18V7m0 8h20v3m-16-3v-6h8c4 0 6 2 6 6"></path><path d="M2 11h5"></path></g></svg>`;
  if (kind === 'lucky') return `<span class="home-glyph" aria-hidden="true">✦</span>`;
  return `<span class="home-glyph vibe-glyph" aria-hidden="true">◇</span>`;
}
