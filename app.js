...
function whatsNewCard() {
  return `<section class="section whats-new-card"><div class="whats-new-copy"><div class="whats-new-kicker"><span class="new-badge">NEW</span><span>Road Trip playlists</span></div><h2>ATM playlists have arrived.</h2><p>Road Trip choices in <b>Music For...</b> now include ATM-curated public playlists on <b>YouTube Music</b>. YouTube Music only for now.</p></div><button id="whatsNewRoadTrips" class="btn primary whats-new-action">Explore Road Trip playlists →</button></section>`;
}
...
function vibe() {
  ...
  const quickChoices = `<section class="section"><div class="eyebrow">Quick vibes</div><h2>Pick a character</h2><p class="small">A faster route when you know the feel you want but not the genre. These use the catalogue’s mood and sonic-profile data; the detailed filters below still work exactly as before.</p><div class="occasion-grid quick-vibes">${vibePresets.map(p => `<button class="occasion-card ${state.vibePreset === p.label ? 'active' : ''}" data-quick-vibe="${attr(p.label)}"><b>${esc(p.label)}</b><span>${esc(p.blurb)}</span></button>`).join('')}</div></section>`;
...
const musicForPresets = [
  { group: 'Road Trips', label: 'Road Trip - Pedal 2 Metal', blurb: 'Riffs, momentum and heavy music built for putting your foot down.', target: { energy: 9, aggression: 8, rhythm: 8, accessibility: 6, organic_electronic: 2 }, genres: ['Metal', 'Punk / Hardcore', 'Rock'], words: ['metal', 'hard rock', 'stoner', 'sludge', 'thrash', 'metalcore', 'hardcore', 'heavy'], playlist: 'https://music.youtube.com/playlist?list=PLUrJGchZxLPY' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Rockit', blurb: 'Big guitars, bigger choruses and windows-down alternative rock.', target: { energy: 8, aggression: 5, rhythm: 7, accessibility: 8, organic_electronic: 2 }, genres: ['Rock', 'Punk / Hardcore'], words: ['alternative rock', 'indie rock', 'pop punk', 'garage rock', 'punk rock', 'anthemic', 'power pop'], playlist: 'https://music.youtube.com/playlist?list=PLGkdal7S-HfI' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Rap It Up', blurb: 'Hip-hop with bounce, hooks and enough momentum for the motorway.', target: { energy: 8, aggression: 6, rhythm: 10, accessibility: 8, organic_electronic: 8 }, genres: ['Hip-Hop'], words: ['hip-hop', 'rap', 'trap', 'grime', 'boom bap', 'swagger', 'confident'], playlist: 'https://music.youtube.com/playlist?list=PLZU1dreNPoP4' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Pop The Hood', blurb: 'Shamelessly good car-pop: hooks, synths and huge singalong choruses.', target: { energy: 8, aggression: 2, rhythm: 9, accessibility: 10, organic_electronic: 8 }, genres: ['Pop'], words: ['dance-pop', 'synth-pop', 'electropop', 'disco', 'euphoric', 'glossy', 'bright'], playlist: 'https://music.youtube.com/playlist?list=PLbLj0wN4QlHM' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Cruise Control', blurb: 'Chilled electronic, indie, soul and psych for when nobody is in a hurry.', target: { energy: 4, aggression: 1, darkness: 3, rhythm: 6, accessibility: 8 }, genres: ['Electronic', 'Rock', 'Soul / R&B / Funk', 'Jazz'], words: ['downtempo', 'chill', 'mellow', 'laid-back', 'warm', 'smooth', 'dream', 'neo-soul'], playlist: 'https://music.youtube.com/playlist?list=PLaNiKoi_QWyU' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Sunset Strip', blurb: 'Yacht rock, funk, soul, disco and city pop for driving into golden hour.', target: { energy: 6, aggression: 1, darkness: 2, rhythm: 8, accessibility: 9 }, genres: ['Rock', 'Pop', 'Soul / R&B / Funk', 'Jazz', 'Electronic'], words: ['yacht rock', 'soft rock', 'funk', 'soul', 'disco', 'boogie', 'city pop', 'sunny', 'warm'], playlist: 'https://music.youtube.com/playlist?list=PLXRrSOmB2PZw' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Country Miles', blurb: 'Country, Americana and heartland music for long roads and big skies.', target: { energy: 6, aggression: 2, darkness: 3, rhythm: 6, accessibility: 8, organic_electronic: 1 }, genres: ['Folk / Singer-Songwriter / Country'], words: ['country', 'americana', 'alt-country', 'heartland', 'rootsy', 'narrative'], playlist: 'https://music.youtube.com/playlist?list=PLNVETnhGip8w' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Autobahn', blurb: 'Motorik, electro, house, techno and synthwave with relentless forward motion.', target: { energy: 8, aggression: 3, darkness: 5, experimental: 6, rhythm: 10, organic_electronic: 10 }, genres: ['Electronic'], words: ['techno', 'house', 'synthwave', 'electro', 'motorik', 'club', 'synth', 'driving'], playlist: 'https://music.youtube.com/playlist?list=PLTllowcDy-ks' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Scenic Route', blurb: 'Post-rock, ambient, dream-pop and spacious music for when the view matters.', target: { energy: 3, aggression: 1, darkness: 5, experimental: 7, accessibility: 5, organic_electronic: 6 }, genres: ['Rock', 'Electronic', 'Experimental / Avant-Garde', 'Pop', 'Folk / Singer-Songwriter / Country'], words: ['post-rock', 'ambient', 'dream pop', 'instrumental', 'spacious', 'cinematic', 'atmospheric', 'serene'], playlist: 'https://music.youtube.com/playlist?list=PLWuavR7dwbWw' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Backseat Karaoke', blurb: 'Maximum chorus, minimum dignity: huge songs for everyone in the car.', target: { energy: 8, aggression: 3, darkness: 2, rhythm: 8, accessibility: 10 }, genres: ['Pop', 'Rock'], words: ['anthemic', 'pop rock', 'power pop', 'dance-pop', 'arena rock', 'euphoric', 'bright'], playlist: 'https://music.youtube.com/playlist?list=PLFz2T8NQPwLM' , strictGenre: true },
  { group: 'Road Trips', label: 'Road Trip - Nu Car', blurb: 'Nu-metal, rap-metal and Y2K heaviness. Baggy jeans optional.', target: { energy: 9, aggression: 8, darkness: 7, rhythm: 8, accessibility: 7, organic_electronic: 4 }, genres: ['Metal', 'Rock', 'Punk / Hardcore'], words: ['nu metal', 'rap rock', 'rap metal', 'alternative metal', 'industrial metal', 'post-grunge'], playlist: 'https://music.youtube.com/playlist?list=PLGxiQgTFwyi4' , strictGenre: true },
...
function musicFor() {
  ...
  const choices = groups.map(group => `<div class="occasion-group ${group === 'Road Trips' ? 'roadtrip-group' : ''}" data-occasion-group="${attr(group)}"><div class="occasion-group-head"><div class="eyebrow">${esc(group)}</div>${group === 'Road Trips' ? '<span class="roadtrip-service">▶ ATM playlists · YouTube Music</span>' : ''}</div><div class="occasion-grid">${musicForPresets.filter(p => p.group === group).map(p => `<button class="occasion-card ${selectedLabel === p.label ? 'active' : ''}" data-occasion="${attr(p.label)}"><b>${esc(p.label)}</b><span>${esc(p.blurb)}</span>${p.playlist ? '<small class="occasion-playlist-note">▶ ATM playlist available</small>' : ''}</button>`).join('')}</div></div>`).join('');
  let results = '';
  if (selected) {
    ...
    const playlistStrip = selected.playlist ? `<div class="playlist-strip"><div><div class="eyebrow">ATM Road Trip playlist</div><b>Take this one with you.</b><span>Public ATM-curated playlist on YouTube Music. The tracklist may keep evolving.</span></div><a class="btn primary playlist-open" href="${attr(selected.playlist)}" target="_blank" rel="noopener">▶ Open in YouTube Music</a></div>` : '';
    results = `<section class="section music-results"><div class="result-head"><div><div class="eyebrow">Music for…</div><h2>${esc(selected.label)}</h2><p class="small">${esc(selected.blurb)} ${randomMode ? 'Randomiser is mixing the qualifying artists.' : 'Ranked by how closely each artist fits the ATM profile.'} Disliked artists are excluded.</p></div><div class="music-result-actions"><button id="musicRanked" class="btn mode-btn ${randomMode ? '' : 'active'}">${musicModeIcon('ranked')}<span>Ranked</span></button><button id="musicRandom" class="btn mode-btn ${randomMode ? 'active' : ''}">${musicModeIcon('random')}<span>Randomiser</span></button><button id="occasionSurprise" class="btn" ${rows.length ? '' : 'disabled'}>✦ Pick one</button></div></div>${playlistStrip}<div class="cards">${rows.slice(0, 18).map((row, i) => recCard({ artist: row.a, score: row.score, why: presetReason(row.a, selected) }, i + 1)).join('')}</div></section>`;
  }
  layout(`<section><div class="eyebrow">Choose the moment</div><h1 class="title">Music for…</h1><p class="subtitle">Pick what the music is for, then let ATM use the catalogue’s mood, energy, rhythm and style profiles to make a shortlist. Road Trip choices also include ATM-curated YouTube Music playlists.</p></section><section class="section occasion-stack">${choices}</section>${results || '<div class="panel empty section">Choose a moment above to see matching artists.</div>'}`, 'musicfor');
...
function guide() {
  ...
  <article class="panel guide-card">${guideHeading(navIcon('home'),'Home')}<p>The home screen groups the four ways to find music together: <b>Artist Match</b>, <b>I’m Feeling Lucky</b>, <b>Vibes</b> and <b>Music For...</b>. A compact <b>What’s New</b> panel highlights the current feature update, with your personal lists and catalogue below.</p></article>
  <article class="panel guide-card">${guideHeading(homeIcon('match'),'Artist Match')}<p>Pick any artist from the full catalogue as your reference point. <b>Closest Match</b>, <b>Broaden It</b> and <b>Wildcard</b> change the kind of musical relationship ATM looks for. <b>Ranked</b> keeps the strongest results first; <b>Randomiser</b> reshuffles a wider pool without changing the selected mode. Recent Artist Match searches can be cleared independently.</p></article>
  <article class="panel guide-card">${guideHeading(homeIcon('vibe'),'Vibes')}<p><b>Quick Vibes</b> are ready-made sonic characters such as Dreamy, Nocturnal, Heavy or Warm &amp; Soulful. <b>Build your own</b> combines primary genres, sub-genres/styles and moods for tighter control. Results can be kept <b>Ranked</b> or reshuffled with <b>Randomiser</b>.</p></article>
  <article class="panel guide-card">${guideHeading(homeIcon('musicfor'),'Music For...')}<p>Choose a real-life moment such as <b>Rainy Days</b>, <b>Drifting Off</b>, <b>Night Driving</b> or <b>“Bedtime” 😉</b>. The new <b>Road Trips</b> section adds genre-led driving recommendations plus direct links to ATM-curated public playlists on <b>YouTube Music</b> (YouTube Music only for now). <b>Ranked</b> keeps the best profile matches first, <b>Randomiser</b> reshuffles the pool, and <b>Pick one</b> jumps straight to an artist.</p></article>
  <article class="panel guide-card">${guideHeading(`<span class="guide-list-pair">${listIcon('explore')}${listIcon('favourite')}</span>`,'Your lists')}<p><b>Favourite</b> is for artists you already value. <b>Want to Explore</b> is your listening queue. Both can be searched and sorted. <b>Dislike</b> keeps an artist out of Lucky, Vibes and Music For... results.</p></article>
  <article class="panel guide-card"><h2>Artists in ATM</h2><p>The catalogue total on Home opens a full A–Z browser. Search across all artists or expand a letter to browse that section.</p></article>
  ...
  <article class="panel guide-card">${guideHeading(navIcon('home'),'Navigation')}<p>The bottom bar gives quick access to <b>Home</b>, <b>Artist Match</b>, <b>Vibes</b>, <b>Music For...</b>, <b>Lucky</b> and <b>Favourites</b>. ATM also uses normal app/browser history, so Back returns through the artist pages and screens you visited.</p></article>
