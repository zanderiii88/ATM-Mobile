...
const legacyMusicForLabels = {
  '3AM': 'After Hours', 'After the Party': 'After Hours',
  'Heartbreak': 'Heavy Heart', 'Moping': 'Heavy Heart', 'Sunday Morning': 'First Coffee',
...
function whatsNewCard() {
  ...
  return `<section class="section whats-new-card"><button id="dismissWhatsNew" class="whats-new-dismiss" type="button" aria-label="Dismiss What’s New">×</button><div class="whats-new-copy"><div class="whats-new-kicker"><span class="new-badge">NEW</span><span>New mixtapes & better matches</span></div><h2>Fresh sounds. Closer connections.</h2><p>Discover Deep Focus, It Got Weird and Neon &amp; Noodles, plus tidier playlists and refined Artist Match recommendations.</p></div><button id="whatsNewPlaylists" class="btn primary whats-new-action">Explore Mixtapes →</button></section>`;
}
...
const musicForPresets = [
  {"label": "Deep Focus", "group": "Time & place", "blurb": "Instrumental grooves, flowing piano and spacious electronics for getting absorbed.", "youtubePlaylist": "https://music.youtube.com/playlist?list=PLbzBlogmZF0g", "spotifyPlaylist": "https://open.spotify.com/playlist/38pTCi25fSb9xAoPnLhvbO", "target": {"energy": 4, "aggression": 1, "darkness": 4, "experimental": 6, "rhythm": 6, "accessibility": 6}, "words": ["ambient", "instrumental", "downtempo", "minimalism", "jazz", "post-rock"], "genres": ["Electronic", "Jazz", "Classical / Modern Composition", "Rock"], "fingerprint": {"target": {"energy": 4, "aggression": 1, "darkness": 4, "experimental": 6, "rhythm": 6, "accessibility": 6}, "words": ["ambient", "instrumental", "downtempo", "minimalism", "jazz", "post-rock"], "genres": ["Electronic", "Jazz", "Classical / Modern Composition", "Rock"], "anchors": []}},
  {"label": "It Got Weird", "group": "ATM Playlists", "blurb": "Odd rhythms, dark corners and adventurous detours through art rock and beyond.", "youtubePlaylist": "https://music.youtube.com/playlist?list=PLRDnwlGAuqdo", "spotifyPlaylist": "https://open.spotify.com/playlist/436qVYVUnmAEk0Si3CufCL", "target": {"energy": 7, "aggression": 5, "darkness": 7, "experimental": 9, "rhythm": 8, "accessibility": 4}, "words": ["experimental rock", "art rock", "progressive", "avant-garde", "math rock", "art pop"], "genres": ["Rock", "Metal", "Electronic", "Pop"], "fingerprint": {"target": {"energy": 7, "aggression": 5, "darkness": 7, "experimental": 9, "rhythm": 8, "accessibility": 4}, "words": ["experimental rock", "art rock", "progressive", "avant-garde", "math rock", "art pop"], "genres": ["Rock", "Metal", "Electronic", "Pop"], "anchors": []}},
  {"label": "Neon & Noodles", "group": "ATM Playlists", "blurb": "The best of Japanese jazz fusion. Tight grooves, bright keys and serious guitar chops.", "youtubePlaylist": "https://music.youtube.com/playlist?list=PLR51UqRPQiL4", "spotifyPlaylist": "https://open.spotify.com/playlist/6vH8OVtnuqEbZfqGmoKTC5", "target": {"energy": 7, "aggression": 2, "darkness": 2, "experimental": 6, "rhythm": 9, "accessibility": 7}, "words": ["jazz fusion", "jazz-funk", "fusion", "jazz funk"], "genres": ["Jazz"], "fingerprint": {"target": {"energy": 7, "aggression": 2, "darkness": 2, "experimental": 6, "rhythm": 9, "accessibility": 7}, "words": ["jazz fusion", "jazz-funk", "fusion", "jazz funk"], "genres": ["Jazz"], "anchors": []}},
  ...
  { group: 'Time & place', label: 'After Hours', blurb: 'Nocturnal, inward-looking and slightly strange.', target: { energy: 4, darkness: 8, experimental: 7 }, words: ['nocturnal', 'hypnotic', 'ambient', 'dream', 'introspective'], youtubePlaylist: 'https://music.youtube.com/playlist?list=PLfBhUHe4j7uM', spotifyPlaylist: 'https://open.spotify.com/playlist/2x0TavgHYPezi8ct1ckqJG' },
  ...
  { group: 'Heart stuff', label: 'Heavy Heart', blurb: 'Songs for the raw bit, the reflective bit and everything after.', target: { energy: 4, darkness: 7, accessibility: 8 }, words: ['heartbreak', 'melancholic', 'romantic', 'vulnerable', 'sad'], youtubePlaylist: 'https://music.youtube.com/playlist?list=PLXTamMNqlNmg', spotifyPlaylist: 'https://open.spotify.com/playlist/3dP40tDl9y2qMTttceygLE' },
...
// Current exported artist references; new playlists use the agreed curation until exported.
const mixtapeBaselineArtists = {"Dancing… to Disco": ["The O'Jays", "KC & The Sunshine Band", "Heatwave", "Rose Royce", "Cheryl Lynn", "Evelyn \"Champagne\" King", "Diana Ross", "Sister Sledge", "Chic", "Bee Gees", "The Trammps", "Gloria Gaynor", "Thelma Houston", "Donna Summer", "Cerrone", "Giorgio Moroder", "ABBA", "Boney M.", "Sylvester", "Patrick Cowley", "Gino Soccio", "Dan Hartman", "Change", "D Train", "Shalamar", "Indeep", "Grace Jones", "L'Impératrice", "Jessie Ware", "Purple Disco Machine"], "Dancing… to Funk": ["James Brown", "Sly & The Family Stone", "The Meters", "Stevie Wonder", "Curtis Mayfield", "The Isley Brothers", "Parliament", "Ohio Players", "Kool & The Gang", "Tower Of Power", "Average White Band", "Betty Davis", "Bootsy Collins", "Herbie Hancock", "Earth, Wind & Fire", "Prince", "Rick James", "The Gap Band", "Zapp", "Cameo", "Lakeside", "Chaka Khan", "Dâm-Funk", "Vulfpeck", "Lettuce", "Khruangbin", "Anderson .Paak", "Childish Gambino"], "Euroshock": ["Cassius", "Etienne de Crécy", "Daft Punk", "Mr. Oizo", "Justice", "Kavinsky", "Vitalic", "Boys Noize", "Digitalism", "Soulwax", "Simian Mobile Disco", "The Bloody Beetroots", "Para One", "Surkin", "Danger", "Zombie Nation", "Alter Ego", "Rex The Dog", "Miss Kittin & The Hacker", "Gesaffelstein", "Ellen Allien", "Modeselektor", "Anthony Rother", "I-f", "Legowelt", "LFO", "Laurent Garnier", "Underworld", "Orbital", "Trentemøller", "Röyksopp", "Breakbot"], "Soft Focus": ["Her's", "Men I Trust", "No Vacation", "Crumb", "Mild High Club", "Mac DeMarco", "TOPS", "The Marías", "Strawberry Guy", "Molly Burch", "Alvvays", "Fazerdaze", "Wild Nothing", "Craft Spells", "Real Estate", "Beach Fossils", "DIIV", "Lush", "Cocteau Twins", "The Radio Dept.", "Melody's Echo Chamber", "Sweet Trip", "Drug Store Romeos", "Japanese Breakfast", "Yumi Zouma", "Kero Kero Bonito", "Air", "Julee Cruise"], "Dancing… in the Pit": ["Gallows", "Cancer Bats", "Have Heart", "Terror", "Trapped Under Ice", "Soul Glo", "Scowl", "DRAIN", "Jesus Piece", "Kublai Khan TX", "Knocked Loose", "Loathe", "Vein.fm", "While She Sleeps", "Bring Me The Horizon", "The Chariot", "The Dillinger Escape Plan", "Converge", "Hatebreed", "At the Drive-In", "Sepultura", "Slipknot"], "First Coffee": ["Stevie Wonder", "Earth, Wind & Fire", "Phoenix", "Vampire Weekend", "Belle and Sebastian", "Camera Obscura", "Metronomy", "Mac DeMarco", "Vulfpeck", "Benny Sings", "Hiatus Kaiyote", "Tom Misch", "Jungle", "Jamiroquai", "Anri", "Incognito", "Norah Jones", "Kings Of Convenience", "Paul Simon", "Talking Heads", "Bill Withers", "Al Green", "Allah-Las", "João Gilberto", "George Benson", "Wes Montgomery", "BADBADNOTGOOD", "Drugdealer", "DOPE LEMON", "Hermanos Gutiérrez", "Stereolab", "Tim Buckley", "Cat Stevens", "Carole King", "Joni Mitchell", "Fleetwood Mac", "America", "Tatsuro Yamashita", "José James"], "Sunset": ["Arc De Soleil", "Helios", "Lemon Jelly", "M83", "Wild Nothing", "Washed Out", "Tame Impala", "Mac DeMarco", "TOPS", "Hermanos Gutiérrez", "Toro y Moi", "Neon Indian", "Röyksopp", "Bonobo", "Four Tet", "Caribou", "Yin Yin", "Parcels", "Anri", "Shakatak"], "Rainy Days": ["The Cure", "Beth Orton", "Talk Talk", "Lamb", "Ride", "Hope Sandoval and the Warm Inventions", "Weyes Blood", "Cocteau Twins", "Crumb", "José González", "Elliott Smith", "Phoebe Bridgers", "Broadcast", "Boards of Canada", "Arooj Aftab"], "Night Driving": ["Kavinsky", "Chromatics", "M83", "The Weeknd", "New Order", "Depeche Mode", "The Knife", "Moderat", "Bicep", "Jon Hopkins", "Underworld", "Orbital", "Gesaffelstein", "Burial", "Trentemøller", "Perturbator", "Carpenter Brut", "Giorgio Moroder", "College & Electric Youth", "The Field", "Nine Inch Nails", "Health", "The Prodigy"], "Heavy Heart": ["Fleetwood Mac", "Sinéad O'Connor", "Frank Ocean", "Adele", "Phoebe Bridgers", "The National", "Bon Iver", "Damien Rice", "Elliott Smith", "Fiona Apple", "Jeff Buckley", "The Cure", "Cat Power", "Sharon Van Etten", "Everything But The Girl", "Beth Gibbons", "Lorde", "Taylor Swift", "Joni Mitchell", "Mitski", "FKA twigs", "James Blake", "Sufjan Stevens", "The Smiths", "Microphones", "Low", "Grouper", "Mojave 3", "Nick Drake", "Sparklehorse", "Songs: Ohia", "Mount Eerie", "Have a Nice Life", "Duster", "Red House Painters", "American Football", "Julien Baker", "Daughter", "Frightened Rabbit"], "Going Out": ["Charli xcx", "Dua Lipa", "Róisín Murphy", "Kylie Minogue", "Tinashe", "Lady Gaga", "Kelela", "Sabrina Carpenter", "Rina Sawayama", "Justice", "Daft Punk", "LCD Soundsystem", "The Chemical Brothers", "Disclosure", "Jamie xx", "KAYTRANADA", "Prince", "Phoenix"], "Falling in Love": ["The Cure", "Al Green", "Minnie Riperton", "The Sundays", "The xx", "Frank Ocean", "Prince", "Lauryn Hill", "Leon Bridges", "Snoh Aalegra", "Beyoncé", "Robyn", "Carly Rae Jepsen", "Chappell Roan", "Talking Heads", "The Postal Service", "Mazzy Star", "Spiritualized", "Cigarettes After Sex", "L'Impératrice", "Metronomy", "Stevie Wonder", "Erykah Badu"], "Brooding": ["Nine Inch Nails", "HEALTH", "Deftones", "Chelsea Wolfe", "Tricky", "UNKLE", "Fever Ray", "The Cure", "Joy Division", "Nick Cave & The Bad Seeds", "TOOL", "A Perfect Circle", "The Soft Moon", "PJ Harvey", "Zola Jesus", "Anna von Hausswolff", "Swans", "Godflesh", "Author & Punisher", "Perturbator", "Boy Harsher", "Type O Negative", "Jesu", "Killing Joke", "Ministry"], "After Hours": ["Burial", "Massive Attack", "Portishead", "James Blake", "The xx", "Boards of Canada", "Radiohead", "Beach House", "Aphex Twin", "Jon Hopkins", "Nils Frahm", "Mazzy Star", "Cigarettes After Sex", "Chromatics", "Fever Ray", "The Knife", "Nine Inch Nails", "Mogwai", "Sigur Rós", "Cocteau Twins", "M83", "Air", "DJ Shadow", "LCD Soundsystem", "The Weeknd", "Frank Ocean", "FKA twigs", "Jessie Ware", "Jamie xx", "Sade", "Blood Orange", "Solange", "Phoebe Bridgers", "Bon Iver", "The National", "Lana Del Rey", "Men I Trust"], "Dancing… to Pop": ["Madonna", "Janet Jackson", "Kylie Minogue", "Britney Spears", "Beyoncé", "Lady Gaga", "Robyn", "Carly Rae Jepsen", "Dua Lipa", "Charli xcx", "Sabrina Carpenter", "Rina Sawayama", "Jessie Ware", "Taylor Swift", "Lorde", "Rihanna", "Ariana Grande", "Christine and the Queens", "MUNA", "Magdalena Bay", "Caroline Polachek", "Pet Shop Boys", "New Order"], "Dancing… to House": ["Frankie Knuckles", "Mr. Fingers", "Robin S", "Crystal Waters", "Stardust", "Daft Punk", "Modjo", "Basement Jaxx", "Groove Armada", "Disclosure", "Bicep", "Fred again", "Overmono", "Peggy Gou", "DJ Koze", "Caribou", "Four Tet", "Floating Points", "The Chemical Brothers", "Underworld", "St Germain", "Moloko", "Eric Prydz", "deadmau5", "Kaskade"], "Wake Up": ["The Hives", "Yeah Yeah Yeahs", "The Strokes", "Bloc Party", "Paramore", "Turnstile", "IDLES", "Fontaines D.C.", "Charli xcx", "Chappell Roan", "Dua Lipa", "Robyn", "OutKast", "Beastie Boys", "Run The Jewels", "Queens Of The Stone Age", "System Of A Down", "The Darkness", "Foo Fighters", "The Chemical Brothers", "M.I.A."], "Calm Down": ["Brian Eno", "Air", "Khruangbin", "Nils Frahm", "Tycho", "Bonobo", "Zero 7", "Sade", "Nick Drake", "Norah Jones", "Men I Trust", "Hermanos Gutiérrez", "Boards of Canada", "Aphex Twin", "Sigur Rós", "Hammock", "Grouper", "Cocteau Twins", "Slowdive", "Bill Evans Trio", "Miles Davis", "Stan Getz", "Wes Montgomery", "George Benson", "Massive Attack"], "Get Hyped": ["Run The Jewels", "Kendrick Lamar", "Denzel Curry", "Little Simz", "Beastie Boys", "Turnstile", "Metallica", "Pantera", "Slipknot", "The Prodigy", "Justice", "The Chemical Brothers", "Charli xcx", "SOPHIE", "Death Grips", "JPEGMAFIA", "Danny Brown", "Queens Of The Stone Age", "JID", "Knocked Loose", "Gojira", "Pusha T"], "Drifting Off": ["Brian Eno", "Aphex Twin", "Stars of the Lid", "Tim Hecker", "Grouper", "William Basinski", "Boards of Canada", "Biosphere", "Nils Frahm", "Ben Russell", "A Winged Victory for the Sullen", "Hammock", "Sigur Rós", "Jon Hopkins", "Oneohtrix Point Never", "Fennesz", "Global Communication", "Orbital", "Tycho", "Cocteau Twins", "Slowdive"], "\"Bedtime\" 😉": ["Sade", "D'Angelo", "Janet Jackson", "Prince", "The Weeknd", "FKA twigs", "Massive Attack", "Portishead", "Jessie Ware", "Snoh Aalegra", "Frank Ocean", "Solange", "Miguel", "Beyoncé", "Sinead Harnett", "Zero 7", "Jordan Rakei", "Al Green", "Erykah Badu", "Blood Orange", "Rhye", "Aphex Twin"], "Aotearoa Calling": ["Lorde", "Crowded House", "OMC", "The Naked And Famous", "Ché-Fu", "Th' Dudes", "Dragon", "Goodshirt", "Zed", "Human Flotsam", "Supergroove", "the feelers", "Shihad", "Skinny Hobos", "The Datsuns", "Alien Weaponry", "Beastwars", "Villainy", "Head Like a Hole", "Spook the Horses", "The Swingers", "The Mint Chicks", "Deja Voodoo", "Sea Mouse", "Racing", "Benedict", "The Mutton Birds", "The Black Seeds", "Split Enz", "BENEE", "Myd", "stellar*", "Fur Patrol", "Patea Maori Club", "Elemeno P", "Goodnight Nurse", "Steriogram", "The Tutts", "Kimbra", "Soft Bait"], "Air Guitar": ["Kansas", "The Jimi Hendrix Experience", "Ram Jam", "The Rolling Stones", "Van Halen", "AC/DC", "Boston", "Motörhead", "The White Stripes", "Creedence Clearwater Revival", "Led Zeppelin", "Living Colour", "Heart", "Wolfmother", "Dire Straits", "Cream", "Iggy Pop", "George Thorogood & The Destroyers", "The Stooges", "Rush", "The Doors", "Jack White", "Joe Satriani", "Extreme", "Mountain", "The Allman Brothers Band", "Herman Rarebell", "ZZ Top", "Ozzy Osbourne", "Deep Purple", "The Jon Spencer Blues Explosion", "Derek & The Dominos", "Alice Cooper", "Blur", "Warrant", "The Cult", "The Undertones", "T. Rex", "Kiss", "Asia", "Suzi Quatro", "Bachman-Turner Overdrive", "Thin Lizzy", "Free", "Rainbow", "Elvis Costello & The Attractions", "Santana", "Robin Trower", "Nazareth", "Ted Nugent", "Dio", "Genesis", "Emerson, Lake & Palmer", "Craigo", "King Gizzard & The Lizard Wizard", "Jack The Fox", "Sean Michael Smith", "Harry and Chris", "T.G. Cid", "Nahko And Medicine For The People", "Camel", "Feeder", "Focus", "Queen", "Queens of the Stone Age", "Nickelback", "Urge Overkill", "Death From Above 1979", "Cheap Talk", "PRIMAL SCREAM", "Primal Scream", "Cobra Man", "Priestess"], "Moshulu Memories": ["No Doubt", "Refused", "System Of A Down", "Drowning Pool", "SOiL", "Evanescence", "Nine Inch Nails", "Rob Zombie", "The Prodigy", "Lit", "Alkaline Trio", "Machine Head", "Metallica", "Slipknot", "Pantera", "The Smashing Pumpkins", "Jane's Addiction", "Limp Bizkit", "Killswitch Engage", "Coal Chamber", "Korn", "blink-182", "OPM", "Deftones", "Linkin Park", "Anthrax", "Powerman 5000", "Rage Against The Machine", "Marilyn Manson", "Tenacious D", "Andrew W.K.", "Kid Rock", "Bloodhound Gang", "Raging Speedhorn", "Amen", "Papa Roach", "Mudvayne", "Queens Of The Stone Age", "Weezer", "Sum 41", "Bowling For Soup", "Dead Kennedys", "Alien Ant Farm", "Incubus", "Jimmy Eat World", "Slayer", "Disturbed", "Brad Durham", "Classic Rock", "Adema", "Green Day", "AFI", "Sick Of It All", "Hatebreed", "Lamb of God", "Black Sabbath", "Sepultura", "Spineshank", "Fear Factory", "Static-X", "FAKE MUSIC", "Nirvana", "You Me At Six", "Mindless Self Indulgence"], "Ambience": ["Brian Eno", "William Basinski", "Terry Riley", "Stars of the Lid", "Tim Hecker", "Laurie Spiegel", "Alice Coltrane", "The Orb", "Oneohtrix Point Never", "Grouper", "Keith Fullerton Whitman", "Iasos", "Alvin Curran", "Julianna Barwick", "Martyn Päsch", "Laraaji", "Biosphere", "Suzanne Ciani", "Clarice Jensen", "Harold Budd", "Ekkehard Ehlers", "Eluvium", "Microstoria", "Huerco S.", "Edgar Froese", "Bing & Ruth"], "Pop Rocks": ["The Lightning Seeds", "Tears For Fears", "Mansun", "The Stone Roses", "Primal Scream", "PRIMAL SCREAM", "Ocean Colour Scene", "Supergrass", "New Order", "Space", "Manic Street Preachers", "The London Suede", "Suede", "Shed Seven", "Blur", "Pickin' On Series", "The Libertines", "Kasabian", "Kaiser Chiefs", "SebastiAn", "The Zutons", "The Futureheads", "Maxïmo Park", "We Are Scientists", "The Knife", "Elastica", "Simple Minds", "Fine Young Cannibals"], "Head Nodding": ["Cypress Hill", "MF DOOM", "Kendrick Lamar", "GZA", "Czarface", "King Geedorah", "The Notorious B.I.G.", "Raekwon", "Rakim", "Gang Starr", "Dilated Peoples", "Big L", "CZARFACE", "Westside Gunn", "Wu-Tang Clan", "DANGERDOOM", "Ol' Dirty Bastard", "Ghostface Killah", "Run The Jewels", "Quasimoto", "Mobb Deep", "Madvillain", "Brother Ali", "Sonnyjim", "Heltah Skeltah", "Viktor Vaughn", "Sean Price", "Slick Rick", "Jurassic 5", "The East Flatbush Project", "NEHRUVIANDOOM", "JJ DOOM", "Mos Def", "DJ Premier", "Freddie Gibbs", "Thea Van Seijen", "Pharahe Monch", "Busta Rhymes", "Ice Cube", "Tyler, The Creator", "Nujabes", "Doechii", "Roots Manuva", "Eric B. & Rakim", "Mark Morrison", "Luniz", "Ini Kamoze", "Skee-Lo", "Warren G", "Soul II Soul", "JID", "Black Sheep", "A Tribe Called Quest"], "Road Trip - Sunset Strip": ["America", "Christopher Cross", "Fleetwood Mac", "Daryl Hall & John Oates", "Kenny Loggins", "Steely Dan", "Wings", "Paul Simon", "Steve Winwood", "George Benson", "Earth, Wind & Fire", "Chic", "Patrice Rushen", "Kool & The Gang", "Marvin Gaye", "Stevie Wonder", "Prince", "Commodores", "Lionel Richie", "The Stylistics", "The Isley Brothers", "Roy Ayers Ubiquity", "Herbie Hancock", "Minnie Riperton", "Curtis Mayfield", "Bill Withers", "Sade", "D'Angelo", "Jamiroquai", "Leon Bridges", "Jordan Rakei", "Hiatus Kaiyote", "Snoh Aalegra", "Anri", "Taeko Onuki", "Masayoshi Takanaka", "CASIOPEA", "L'Impératrice", "Breakbot", "Daft Punk", "Chromeo", "Phoenix", "Tame Impala", "Jungle", "Khruangbin", "Men I Trust", "Unknown Mortal Orchestra", "DOPE LEMON", "Air"], "Road Trip - Autobahn": ["Kraftwerk", "Underworld", "Daft Punk", "Justice", "Kavinsky", "Moderat", "Jon Hopkins", "Orbital", "The Chemical Brothers", "Leftfield", "The Prodigy", "Bicep", "Overmono", "Daniel Avery", "Ellen Allien", "Astronauts Etc.", "Soulwax", "Vitalic", "Boys Noize", "Digitalism", "Simian Mobile Disco", "M83", "College & Electric Youth", "Chromatics", "The Midnight", "GUNSHIP", "Carpenter Brut", "Perturbator", "Magic Sword", "Com Truise", "Tycho", "Lindstrøm", "Todd Terje", "Röyksopp", "Alan Braxe", "Cassius", "Etienne De Crécy", "St Germain", "Luke Slater", "Jeff Mills", "Paperclip People", "Model 500", "Inner City", "Yello", "New Order", "Depeche Mode", "Gary Numan", "The KLF", "The Future Sound Of London", "LFO"], "Road Trip - Backseat Karaoke": ["Queen", "4 Non Blondes", "ABBA", "Alanis Morissette", "Avril Lavigne", "Beyoncé", "Billy Joel", "blink-182", "Bon Jovi", "Britney Spears", "Bryan Adams", "Carly Rae Jepsen", "Céline Dion", "Chappell Roan", "Cher", "Christina Aguilera", "Def Leppard", "Dexys Midnight Runners", "Dua Lipa", "Elton John", "Erasure", "Fleetwood Mac", "Foo Fighters", "George Michael", "Green Day", "Guns N' Roses", "Jimmy Eat World", "Journey", "Katy Perry", "Kelly Clarkson", "Lady Gaga", "Meat Loaf", "Miley Cyrus", "Oasis", "P!NK", "Paramore", "Rihanna", "Shania Twain", "Soft Cell", "Tears For Fears", "Taylor Swift", "The Cranberries", "The Human League", "The Killers", "Tina Turner", "Toto", "Wham!", "Whitney Houston", "Michael Jackson", "Crazy Town"], "Road Trip - Country Miles": ["Johnny Cash", "Willie Nelson", "Dolly Parton", "Waylon Jennings", "Merle Haggard", "Merle Haggard & The Strangers", "George Strait", "Country Studio Crew", "Reba McEntire", "Alan Jackson", "Brooks & Dunn", "Shania Twain", "The Chicks", "Faith Hill", "Tim McGraw", "Kenny Chesney", "Toby Keith", "LeAnn Rimes", "Chris Stapleton", "Sturgill Simpson", "Tyler Childers", "Jason Isbell", "Zach Bryan", "Kacey Musgraves", "Orville Peck", "Sierra Ferrell", "Charley Crockett", "Colter Wall", "Turnpike Troubadours", "Drive-By Truckers", "Wilco", "Son Volt", "Old 97's", "Lucinda Williams", "Gillian Welch", "Emmylou Harris", "Steve Earle", "Townes Van Zandt", "Gram Parsons", "The Flying Burrito Brothers", "Neil Young", "Tom Petty", "The War On Drugs", "Bruce Springsteen", "Lucero", "Waxahatchee", "Plains", "Margo Price", "Yola", "Adeem the Artist"], "Road Trip - Cruise Control": ["Air", "Alfa Mist", "Arc De Soleil", "BADBADNOTGOOD", "Space Doves", "Bibio", "Boards of Canada", "Bonobo", "Caribou", "Cigarettes After Sex", "D'Angelo", "DJ Shadow", "DOPE LEMON", "dreamsoda", "ZERO GR4VITY", "Four Tet", "Erykah Badu", "Groove Armada", "Hermanos Gutiérrez", "Jordan Rakei", "Khruangbin", "Kruder & Dorfmeister", "Lemon Jelly", "Leon Bridges", "L'Impératrice", "Little Dragon", "Mac DeMarco", "Massive Attack", "Men I Trust", "Mild High Club", "Morcheeba", "Nightmares On Wax", "Nujabes", "Parcels", "Portishead", "Real Estate", "JON MCXRO", "Röyksopp", "Sade", "Skinshape", "Snoh Aalegra", "St Germain", "Family", "Thievery Corporation", "Tom Misch", "Tycho", "Washed Out", "Yin Yin", "Zero 7"], "Road Trip - Nu Car": ["Korn", "System Of A Down", "Slipknot", "Limp Bizkit", "(Hed) Planet Earth", "40 Below Summer", "Adema", "Brad Durham", "Chevelle", "Coal Chamber", "Cold", "Cypress Hill", "Deftones", "Drowning Pool", "Dry Kill Logic", "Evanescence", "Flyleaf", "Godsmack", "Hoobastank", "Ill Niño", "In Flames", "Incubus", "Kittie", "Lacuna Coil", "Linkin Park", "Machine Head", "Mudvayne", "Mushroomhead", "Nonpoint", "Nothingface", "OTEP", "P.O.D.", "Papa Roach", "Powerman 5000", "Primer 55", "Rage Against The Machine", "Reveille", "Saliva", "Sepultura", "Sevendust", "Snot", "Soulfly", "Spineshank", "SOiL", "Staind", "Static-X", "Taproot", "The Union Underground", "TRUSTcompany", "Marilyn Manson"], "Road Trip - Pedal 2 Metal": ["Alice in Chains", "Anthrax", "At The Gates", "Baroness", "Boris", "Carcass", "Code Orange", "Converge", "Deafheaven", "Deftones", "Elder", "Entombed", "Every Time I Die", "Faith No More", "Gatecreeper", "Gojira", "Helmet", "High On Fire", "In Flames", "Iron Maiden", "Judas Priest", "Killswitch Engage", "ALEX HAAN", "Knocked Loose", "Kyuss", "Lamb of God", "Machine Head", "Mastodon", "Megadeth", "Meshuggah", "Metallica", "Motörhead", "Opeth", "Pantera", "Power Trip", "Queens Of The Stone Age", "Rage Against The Machine", "Red Fang", "Refused", "Sepultura", "Slayer", "Sleep", "Soundgarden", "System Of A Down", "TOOL", "Torche", "Trivium", "Turnstile", "Rammstein"], "Road Trip - Pop The Hood": ["Dua Lipa", "Sabrina Carpenter", "The Weeknd", "Ariana Grande", "Beyoncé", "Sunset Party", "Britney Spears", "Bruno Mars", "Carly Rae Jepsen", "Blossoms", "Chappell Roan", "surround.", "Allie X", "Christina Aguilera", "Enmity", "Doja Cat", "Girls Aloud", "Gwen Stefani", "HAIM", "Halsey", "Harry Styles", "Jessie Ware", "Justin Bieber", "Katy Perry", "Kelly Clarkson", "Kylie Minogue", "La Roux", "Lady Gaga", "Party Tyme", "Lorde", "Madonna", "Miley Cyrus", "MUNA", "Nelly Furtado", "No Doubt", "Olivia Rodrigo", "Paramore", "Post Malone", "Rihanna", "Xs", "Robyn", "Selena Gomez", "Shakira", "Sophie Ellis-Bextor", "Sugababes", "SZA", "Taylor Swift", "Troye Sivan", "Olly Alexander (Years & Years)"], "Road Trip - Rap It Up": ["Outkast", "21 Savage", "50 Cent", "A Tribe Called Quest", "A$AP Rocky", "Beastie Boys", "Black Star", "Busta Rhymes", "Cardi B", "Clipse", "Common", "Danny Brown", "De La Soul", "Game", "DMX", "Doja Cat", "Dr. Dre", "Drake", "Eminem", "Freddie Gibbs", "Future", "Gang Starr", "JAŸ-Z", "-LEX-", "Kanye West", "Kevin McFly", "Lil Wayne", "Kid Cudi", "Little Simz", "Ludacris", "Mac Miller", "Megan Thee Stallion", "MF DOOM", "Missy Elliott", "Mobb Deep", "Mos Def", "Nas", "Nelly", "Public Enemy", "Pusha T", "Ski Mask The Slump God", "Run The Jewels", "ScHoolboy Q", "Snoop Dogg", "Ice Cube", "T.I.", "The Roots", "surround.", "Travis Scott", "Vince Staples", "Wu-Tang Clan"], "Road Trip - Rockit": ["The Strokes", "Alice In Chains", "Alvvays", "Arctic Monkeys", "Biffy Clyro", "Bloc Party", "Blur", "Feeder", "FONTAINES D.C.", "Foo Fighters", "Krystyn", "IDLES", "Interpol", "Lee Morse", "Green Day", "Jimmy Eat World", "Manic Street Preachers", "Muse", "Nirvana", "Panic! At The Disco", "Pearl Jam", "Phoenix", "Pixies", "Placebo", "Pulp", "Queens of the Stone Age", "Radiohead", "Royal Blood", "Soundgarden", "The Beths", "Geese", "The Darkness", "The Gaslight Anthem", "The Hives", "The Libertines", "The Smashing Pumpkins", "The Vaccines", "The Vines", "The War On Drugs", "The White Stripes", "Turnstile", "Weezer", "TOWA TEI", "Wolf Alice", "Yeah Yeah Yeahs", "Urge Overkill", "High Fade"], "Road Trip - Scenic Route": ["A Winged Victory for the Sullen", "Air", "Balmorhea", "Bark Psychosis", "Beach House", "Boards of Canada", "Bon Iver", "Brian Eno", "Calexico", "Caspian", "Cocteau Twins", "Do Make Say Think", "Fleet Foxes", "godspeed you black emperor!", "Grouper", "Hammock", "Harold Budd", "Helios", "Hermanos Gutiérrez", "Joni Mitchell", "Julianna Barwick", "Khruangbin", "Max Richter", "Mazzy Star", "Mogwai", "MONO", "Neil Young", "Nils Frahm", "Oneohtrix Point Never", "Pink Floyd", "Radiohead", "Russian Circles", "Sigur Rós", "Slowdive", "Spiritualized", "Stars of the Lid", "Sufjan Stevens", "Talk Talk", "The Album Leaf", "The Smile", "This Will Destroy You", "Tim Hecker", "Tycho", "William Basinski"], "Deep Focus": ["Gidge", "Emancipator", "Kiasmos", "Rival Consoles", "Loscil", "Bing & Ruth", "Grandbrothers", "GoGo Penguin", "Mammal Hands", "Portico Quartet", "BADBADNOTGOOD", "Khruangbin", "El Ten Eleven", "Tourist", "Ólafur Arnalds", "Hania Rani", "Ryuichi Sakamoto", "Hiroshi Yoshimura", "Ulrich Schnauss", "Yppah"], "It Got Weird": ["Puscifer", "A Perfect Circle", "Tool", "Porcupine Tree", "Primus", "King Crimson", "The Mars Volta", "black midi", "Mr. Bungle", "Tomahawk", "Sleepytime Gorilla Museum", "Cardiacs", "Devo", "Talking Heads", "Can", "Battles", "Liars", "Bent Knee", "Björk", "Portishead", "Scott Walker", "David Bowie"], "Neon & Noodles": ["Casiopea", "T-Square", "Masayoshi Takanaka", "Himiko Kikuchi", "Naniwa Express", "Kazumi Watanabe", "Naoya Matsuoka", "Jun Fukamachi", "Jiro Inagaki & His Soul Media", "Akira Ishikawa & His Count Buffalos", "Ryo Kawasaki", "Hiroshi Fukumura", "Sadao Watanabe", "PRISM", "Masaru Imada"]};
for (const preset of musicForPresets) {
  if (preset.playlistOnly || !mixtapeBaselineArtists[preset.label]) continue;
  preset.fingerprint ||= {target: preset.target, words: preset.words, genres: preset.genres};
  preset.fingerprint.anchors = mixtapeBaselineArtists[preset.label];
}
...
const mixtapeBaselineRules = {
  ...
  'Deep Focus': {maxTraits: {aggression: 3, energy: 7}},
  'Neon & Noodles': {coreWords: ['fusion', 'jazz-funk', 'jazz funk'], maxTraits: {aggression: 4}},
...
// Export-backed references are a dated snapshot, not live audio analysis.
